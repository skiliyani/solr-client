...
public class SolrJSearcherZocDoc extends SolrSearcher {
    ...
    public static void main(String[] args) throws Exception {
        ...
        //String fq = "source:zocdoc AND source_status:pending";
        String fq = "source:zocdoc";
    ...
    protected static String getSourceQuery(SolrDocument document) {
        ...
        builder.append("firstname:").append(document.get("Provider_First_Name")).append("^10.0");
        builder.append(" AND ").append("lastname:").append(document.get("Provider_Last_Name")).append("^10.0");
        builder.append(" AND ").append("middlename:").append(document.get("Provider_Middle_Name")).append("^10.0");
